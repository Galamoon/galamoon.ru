...
?>
    ...
    <p>Программист PHP, сертифицированный разработчик 1С-Битрикс, имею большой опыт разработки интернет-магазинов,
        ...
        системами и службами доставки. Пишу код согласно здравому смыслу и PSR. <br> Работаю ведущим программистом, тимлидом в аутсорс-продакшн компании <a rel="noopener noreferrer" href="https://ylab.io/">Ylab</a>.</p>
    <div>
